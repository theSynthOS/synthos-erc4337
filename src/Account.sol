...
// Extensions
import "@thirdweb/contracts/prebuilts/account/utils/AccountCore.sol";
import "@thirdweb/contracts/extension/upgradeable/ContractMetadata.sol";
import "@thirdweb/contracts/external-deps/openzeppelin/token/ERC721/utils/ERC721Holder.sol";
import "@thirdweb/contracts/external-deps/openzeppelin/token/ERC1155/utils/ERC1155Holder.sol";
...
contract Account is AccountCore, ContractMetadata, ERC1271, ERC721Holder, ERC1155Holder {
    ...
    address public policyCoordinator;
    ...
    function setPolicyCordinator(address _policyCordinator) public {
        _onlyAdmin();
        policyCoordinator = _policyCordinator;
    }
}
